...
class FuzzyController(ControllerBase):
    ...
    def __init__(self):
        ...
        """
        # print('run initiated')
        individualbest = [599, 486, 157, 104, 243, 59, 522, 521, 83, 872, 191, 71, 862, 215, 439, 274, 719, 960, 700,
                          664,
                          74, 624, 651, 176, 547, 747, 251, 168, 474, 389, 277, 948, 656, 705, 571, 225, 434, 979, 466,
                          787,
                          795, 291, 235, 615]
        individual = individualbest
